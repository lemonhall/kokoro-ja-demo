 ...
 * misaki_tokenizer.c
 * 
 * Misaki C Port - Tokenizer Common Implementation
 * 分词器公共实现（Token、TokenList、DAG）
 * 
 * 语言特定实现已移至：
 * - misaki_tokenizer_zh.c - 中文分词
 * - misaki_tokenizer_en.c - 英文分词
 * - misaki_tokenizer_ja.c - 日文分词
 * 
 * License: MIT
 */
